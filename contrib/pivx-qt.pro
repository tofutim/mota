...
RESOURCES += src/qt/mota.qrc src/qt/mota_locale.qrc

TRANSLATIONS += src/qt/locale/mota_bg.ts \
                src/qt/locale/mota_de.ts \
                src/qt/locale/mota_en.ts \
                src/qt/locale/mota_es.ts \
                src/qt/locale/mota_fi.ts \
                src/qt/locale/mota_fr.ts \
                src/qt/locale/mota_it.ts \
                src/qt/locale/mota_ja.ts \
                src/qt/locale/mota_pl.ts \
                src/qt/locale/mota_pt.ts \
                src/qt/locale/mota_ru.ts \
                src/qt/locale/mota_sk.ts \
                src/qt/locale/mota_sv.ts \
                src/qt/locale/mota_vi.ts \
                src/qt/locale/mota_zh_CN.ts \
                src/qt/locale/mota_zh_TW.ts
