Contributing to MOTA Core
============================

The MOTA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MOTA Core project, and is not to be
confused with overall MOTA Network Protocol consensus changes.

Whether a pull request is merged into MOTA Core rests with the project merge
...
Patches that change MOTA consensus rules are considerably more involved than
...
Where a patch set proposes to change the MOTA consensus, it must have been
...
The project leader is the release manager for each MOTA Core release.
