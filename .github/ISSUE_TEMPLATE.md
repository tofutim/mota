...
This issue tracker is only for technical issues related to MOTA Core.
General MOTA questions and/or support requests and are best directed to the [MOTA Slack](http://mota.slack.com).
...
### What version of MOTA Core are you using?
