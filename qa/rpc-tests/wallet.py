...
#   c) node1 mines 32 blocks, so now node 0 has 60001mota, node 1 has 4250mota, node2 has none.
#   d) node0 sends 601 mota to node2, in two transactions (301 mota, then 300 mota).
