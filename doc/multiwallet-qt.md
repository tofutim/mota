...
In order to support loading of multiple wallets in mota-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mota.cpp.
...
Changes to mota.cpp
----------------------
mota.cpp is the entry point into mota-qt, and as such, will require some minor modifications to provide hooks for
